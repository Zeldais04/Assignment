...
public class NavigationMenuTag extends SimpleTagSupport {
    ...
    public void doTag() throws JspException, IOException {
        ...
        out.write(
                ...
                + "<a href='" + contextPath + "/home.jsp' style='color: black; padding: 12px 16px; text-decoration: none; display: block;'>Home</a>"
                + "<a href='" + contextPath + "/profile.jsp' style='color: black; padding: 12px 16px; text-decoration: none; display: block;'>Profile</a>"
                + "<a href='" + contextPath + "/settings.jsp' style='color: black; padding: 12px 16px; text-decoration: none; display: block;'>Settings</a>"
                + "<a href='" + contextPath + "/logout' style='color: black; padding: 12px 16px; text-decoration: none; display: block;'>Logout</a>"  // Đường dẫn logout đã được sửa đổi
                + "</div>"
                + "</div>"
                + "<script>"
